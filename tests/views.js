...
tap.test('views - login', test => {
  test.doesNotThrow(login.bind(null, fakeRender))
  test.end()
})

const { bookCardView } = require('../views/book-card.js')
tap.test('views - bookCardView', test => {
  test.doesNotThrow(bookCardView.bind(null, () => fakeRender))
  test.end()
})
tap.test('views - bookCardView', test => {
  test.doesNotThrow(bookCardView.bind(null, () => fakeRender, {}))
...
tap.test('views - bookCardView with model', test => {
  test.doesNotThrow(
    bookCardView.bind(null, () => fakeRender, {
...
tap.test('views - navSidebarView', test => {
  test.doesNotThrow(
    navSidebarView.bind(null, () => fakeRender, {}, { path: '/library' })
  )
  test.end()
})
...
tap.test('views - importPageBody', test => {
  test.doesNotThrow(
    importPageBody.bind(null, () => fakeRender, {}, { path: '/library' })
  )
  test.end()
})
...
tap.test('views - libraryBody', test => {
  test.doesNotThrow(
    libraryBody.bind(null, () => fakeRender, {}, { path: '/library' })
  )
  test.end()
})
...
tap.test('views - settingsPageBody', test => {
  test.doesNotThrow(
    settingsPageBody.bind(null, () => fakeRender, {}, { path: '/library' })
  )
  test.end()
})
