...
!(function (t, e) {
  typeof exports === 'object' && typeof module === 'object'
    ...
    : typeof define === 'function' && define.amd
      ? define([], e)
      : typeof exports === 'object' ? (exports.Quill = e()) : (t.Quill = e())
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function r (t, e) {
        var n = i(t)
        if (n == null) throw new s('Unable to create ' + t + ' blot')
        var r = n
        return new r(
      ...
      function i (t, e) {
        ...
        return n == null
          ? null
          : e & p.LEVEL & n.scope && e & p.TYPE & n.scope ? n : null
      }
      function l () {
        ...
        if (((h[n.blotName || n.attrName] = n), typeof n.keyName === 'string')) { u[n.keyName] = n } else if (
          (n.className != null && (c[n.className] = n), n.tagName != null)
        ) {
          ...
          r.forEach(function (t) {
            ;(f[t] != null && n.className != null) || (f[t] = n)
          })
        }
        return n
      }
    ...
    function (t, e) {
      ...
      t.exports = function t () {
        var e,
          ...
          h = !1
        for (
          typeof u === 'boolean' && ((h = u), (u = arguments[1] || {}), (c = 2)),
    ...
    function (t, e, n) {
      ...
      function a (t) {
        ...
        return t == null
          ? e
          : (typeof t.formats === 'function' &&
              (e = (0, f.default)(e, t.formats())),
          t.parent == null ||
            t.parent.blotName == 'scroll' ||
                ...
                return (
                  this.cache.delta == null &&
                    (this.cache.delta = this.descendants(y.default.Leaf)
                      .reduce(function (t, e) {
                        return e.length() === 0 ? t : t.insert(e.value(), a(e))
                      }, new p.default())
                      .insert('\n', a(this))),
                  this.cache.delta
                )
    ...
    function (t, e, n) {
      ...
      (s.prototype.push = function (t) {
        var e = this.ops.length,
          n = this.ops[e - 1]
        if (((t = i(!0, {}, t)), typeof n === 'object')) {
          if (typeof t.delete === 'number' && typeof n.delete === 'number') { return (this.ops[e - 1] = { delete: n.delete + t.delete }), this }
          if (
            typeof n.delete === 'number' &&
              t.insert != null &&
              ((e -= 1), typeof (n = this.ops[e - 1]) !== 'object')
      ...
      (s.prototype.diff = function (t, e) {
        ...
        var n = [this, t].map(function (e) {
            return e
              .map(function (n) {
                if (n.insert != null) { return typeof n.insert === 'string' ? n.insert : a }
                var r = e === t ? 'on' : 'with'
    ...
    function (t, e, n) {
      ...
      function l (t, e) {
        if (
          ...
          if (((e.theme = S.import('themes/' + e.theme)), e.theme == null)) {
            throw new Error(
        ...
        return (
          ...
          ['bounds', 'container', 'scrollingContainer'].forEach(function (t) {
            typeof e[t] === 'string' && (e[t] = document.querySelector(e[t]))
          }),
      ...
      function a (t, e, n, r) {
        ...
        if (
          (o != null &&
            (!0 === n && (n = o.index),
            r == null ? (o = u(o, l, e)) : r !== 0 && (o = u(o, n, r, e)),
      ...
      function s (t, e, n, r, o) {
        var i = {}
        return (
          typeof t.index === 'number' && typeof t.length === 'number'
            ? typeof e !== 'number'
              ? ((o = r), (r = n), (n = e), (e = t.length), (t = t.index))
              : ((e = t.length), (t = t.index))
            : typeof e !== 'number' && ((o = r), (r = n), (n = e), (e = 0)),
          (void 0 === n ? 'undefined' : c(n)) === 'object'
            ? ((i = n), (o = r))
            : typeof n === 'string' && (r != null ? (i[n] = r) : (o = n)),
          ...
          return (
            ...
            h(t, [
              ...
              },
              {
                key: 'setSelection',
                value: function (e, n, r) {
                  if (e == null) { this.selection.setRange(null, n || t.sources.API) } else {
                    var o = s(e, n, r),
                      i = f(o, 4)
                    ;(e = i[0]),
                    (n = i[1]),
    ...
    function (t, e, n) {
      ...
      function o (t) {
        return (
          !(!t || typeof t !== 'object' || typeof t.length !== 'number') &&
            ...
            [
                ...
                value: function (t, n) {
                  if (t !== this.statics.blotName || !n) {
                    var r = this.descendant(m.default, this.length() - 1),
                      o = a(r, 1),
                      i = o[0]
                    i != null && i.deleteAt(i.length() - 1, 1),
                    u(
                      e.prototype.__proto__ ||
                          Object.getPrototypeOf(e.prototype),
                      'format',
              ...
              },
              {
                ...
                value: function (t, n, r, o) {
                  if (
                    n !== 0 &&
                    p.default.query(r, p.default.Scope.BLOCK) != null &&
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (
                    ...
                    if (typeof Event === 'function') { this.select.dispatchEvent(new Event('change')) } else if (
                      (typeof Event === 'undefined' ? 'undefined' : l(Event)) ===
                      'object'
                    ) {
        ...
        s = (function (t) {
          ...
          return (
            ...
            (e.prototype.optimize = function (e) {
              if (
                (t.prototype.optimize.call(this, e), this.children.length === 0)
              ) {
            ...
            (e.prototype.update = function (t, e) {
              ...
              o
                ...
                .forEach(function (t) {
                  ...
                  var o = r(t)
                    ;(o.next == e && o.next != null) ||
                      (o.parent != null && o.parent.removeChild(n),
    ...
    function (t, e, n) {
      ...
      var o = n(12),
        ...
        l = {
          ...
          length: function (t) {
            return typeof t.delete === 'number'
              ? t.delete
              : typeof t.retain === 'number'
                ? t.retain
                : typeof t.insert === 'string' ? t.insert.length : 1
          }
        }
    ...
    function (t, e, n) {
            ...
            if (a != null) {
              ...
              h.forEach(function (e, i) {
                t
                  ...
                  (s += n.TAB.length),
                  i === 0 ? (r += n.TAB.length) : (o += n.TAB.length))
                  : e.startsWith(n.TAB) &&
      ...
      function y (t) {
        ...
        if (
          ((void 0 === t ? 'undefined' : v(t)) === 'object' &&
            (t = (0, _.default)(t, !1)),
          typeof t.key === 'string')
        ) {
          if (D.keys[t.key.toUpperCase()] != null) { t.key = D.keys[t.key.toUpperCase()] } else {
                      ...
                      if (o.length !== 0) {
                        ...
                        if (i != null && t.quill.hasFocus()) {
                          ...
                          o.some(function (e) {
                            ...
                            if (e.empty != null && e.empty !== x.empty) { return !1 }
                            if (e.offset != null && e.offset !== x.offset) { return !1 }
                            ...
                            return (
                              !(e.prefix != null && !e.prefix.test(x.prefix)) &&
                              (!(
                                e.suffix != null && !e.suffix.test(x.suffix)
                              ) &&
      ...
      var r = n(1),
        o = (function () {
          ...
          return (
            ...
            (t.create = function (t) {
              if (this.tagName == null) { throw new r.ParchmentError('Blot definition missing tagName') }
              var e
              return (
            ...
            (t.prototype.wrap = function (t, e) {
              var n = typeof t === 'string' ? r.create(t, e) : t
              return (
                this.parent != null && this.parent.insertBefore(n, this.next),
                n.appendChild(this),
                n
              )
            }),
            ...
            u(e, [
              ...
              },
              {
                ...
                value: function (t, n) {
                  ...
                  for (
                    var r = this, o = 0;
                    r != null && r.statics.scope !== f.default.Scope.BLOCK_BLOT;
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  if (
                    t.some(function (t) {
                      return (
                        t.type === 'characterData' && t.target === n.textNode
                      )
                    })
                  ) {
                    var r = this.restore()
            ...
            o(t, [
              {
                ...
                value: function () {
                  ...
                  Object.keys(this.options.modules).forEach(function (e) {
                    t.modules[e] == null && t.addModule(e)
                  })
                }
              },
              {
                  ...
                  t.forEach(function (t) {
                    ;(t.getAttribute('class') || '')
                      ...
                      .forEach(function (n) {
                        if (
                          n.startsWith('ql-') &&
                          ((n = n.slice('ql-'.length)), e[n] != null)
                        ) {
                          if (n === 'direction') { t.innerHTML = e[n][''] + e[n].rtl } else if (typeof e[n] === 'string') t.innerHTML = e[n]
                          else {
                            var r = t.value || ''
                ...
                value: function (t, e) {
                  ...
                  this.pickers = t.map(function (t) {
                    if (t.classList.contains('ql-align')) {
                      return (
                        t.querySelector('option') == null && s(t, q),
        ...
        return (
          ...
          (t.prototype.find = function (t, e) {
            ...
            for (var n, r = this.iterator(); (n = r());) {
              ...
              if (
                t < o ||
                (e && t === o && (n.next == null || n.next.length() !== 0))
              ) { return [n, t] }
              t -= o
            }
            return [null, 0]
              ...
              for (
                var a = function (t, e) {
                    ...
                    t != null &&
                        ...
                        (t.domNode[i.DATA_KEY].mutations == null &&
                          (t.domNode[i.DATA_KEY].mutations = []),
                        e && a(t.parent))
                  },
                  s = function (t) {
                    t.domNode[i.DATA_KEY] != null &&
                      t.domNode[i.DATA_KEY].mutations != null &&
            ...
            (e.prototype.update = function (e, n) {
              ...
              e
                .map(function (t) {
                  ...
                  return e == null
                    ? null
                    : e.domNode[i.DATA_KEY].mutations == null
              ...
              this.domNode[i.DATA_KEY].mutations != null &&
      ...
      var o = n(18),
        ...
        l = (function (t) {
          ...
          return (
            ...
            (e.prototype.format = function (n, r) {
              i.query(n, i.Scope.BLOCK) != null &&
                (n !== this.statics.blotName || r
                  ? t.prototype.format.call(this, n, r)
                  : this.replaceWith(e.blotName))
            }),
            (e.prototype.formatAt = function (e, n, r, o) {
              i.query(r, i.Scope.BLOCK) != null
                ? this.format(r, o)
                : t.prototype.formatAt.call(this, e, n, r, o)
            }),
            (e.prototype.insertAt = function (e, n, r) {
              if (r == null || i.query(n, i.Scope.INLINE) != null) { t.prototype.insertAt.call(this, e, n, r) } else {
                var o = this.split(e),
                  l = i.create(n, r)
    ...
    function (t, e) {
      ...
      ;(e = t.exports = typeof Object.keys === 'function' ? Object.keys : n),
      (e.shim = n)
    },
    function (t, e) {
      function n (t) {
                ...
                value: function (t, n, r) {
                  if (
                    ...
                    if (t >= this.length()) {
                      if (
                        r == null ||
                        h.default.query(n, h.default.Scope.BLOCK) == null
                      ) {
    ...
    function (t, e, n) {
      ...
      function s (t, e, n) {
        return (void 0 === e ? 'undefined' : x(e)) === 'object'
        ...
        return (
          n
            ...
            .forEach(function (e) {
              ...
              ;(n != null && ((i[n.attrName] = n.value(t)), i[n.attrName])) ||
                ((n = Y[e]),
                n == null ||
      ...
      function g (t, e) {
        ...
        for (
          ...
          (P.default.query(o) || {}).blotName === 'list' && (r += 1),
          (o = o.parentNode)
        }
        return r <= 0
          ? e
      ...
      function O (t, e) {
        var n = {},
          r = t.style || {}
        return (
          r.fontStyle && u(t).fontStyle === 'italic' && (n.italic = !0),
          r.fontWeight &&
      ...
      function w (t, e) {
        ...
        if (!u(t.parentNode).whiteSpace.startsWith('pre')) {
          ...
          ((t.previousSibling == null && f(t.parentNode)) ||
              (t.previousSibling != null && f(t.previousSibling))) &&
              (n = n.replace(/^\s+/, r.bind(r, !1))),
          ((t.nextSibling == null && f(t.parentNode)) ||
              (t.nextSibling != null && f(t.nextSibling))) &&
              (n = n.replace(/\s+$/, r.bind(r, !1)))
        }
        return e.insert(n)
      }
    ...
    function (t, e, n) {
      ...
      function a (t) {
        ...
        return (
          e != null &&
          (e.insert != null
            ? typeof e.insert === 'string' && e.insert.endsWith('\n')
            : e.attributes != null &&
            ...
            r = function (e) {
              if (e.target.parentNode === t) {
                ...
                r === 'checked'
                  ...
                  : r === 'unchecked' && o.format('list', 'checked')
              }
            }
          return (
          ...
          return (
            ...
            l(e, null, [
              ...
              },
              {
                key: 'formats',
                value: function (t) {
                  return t.tagName === 'SUB'
                    ? 'sub'
                    : t.tagName === 'SUP' ? 'super' : void 0
                }
              }
            ]),
            e
                  ...
                  if (n) {
                    if (
                      ...
                      if (
                        ...
                        this.quill.scroll.whitelist[n] == null
                      ) {
                        return void x.warn(
                ...
                value: function (t) {
                  ...
                  this.controls.forEach(function (n) {
                    ...
                    if (i.tagName === 'SELECT') {
                      var l = void 0
                      if (t == null) l = null
                      else if (e[o] == null) { l = i.querySelector('option[selected]') } else if (!Array.isArray(e[o])) {
                        var a = e[o]
            ...
            if (e != null) {
              if (e.length == 0) {
                ...
                Object.keys(n).forEach(function (e) {
                  v.default.query(e, v.default.Scope.INLINE) != null &&
                      t.quill.format(e, !1)
                })
